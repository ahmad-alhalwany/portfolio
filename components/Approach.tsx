  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-center text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 mt-4 group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200"
            style={{ color: "#E4ECFF" }}>
          {description}
        </h2>
      </div>
