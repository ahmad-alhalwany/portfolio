...
export const siteConfig = {
  ...
  title: "Ahmad Al-Halwany | AI Application Developer",
  description:
    "Ahmad Halwany — AI Application Developer building production AI products with ML, LLM/RAG and full-stack (Python, Next.js). Portfolio and live projects.",
  locale: "en_US",
  language: "en",
